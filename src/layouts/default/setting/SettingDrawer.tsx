...
import { MenuTypeEnum, TriggerEnum } from '@/constants/menuEnum'
...
import { HEADER_PRESET_BG_COLOR_LIST, SIDE_BAR_BG_COLOR_LIST, APP_PRESET_COLOR_LIST } from '@/config/designConfig'
